...
This document is dedicated for catalog item developers.
...
To register new components or catalog items in SURF Research cloud you 
...
- Set description fields:
  ...
  - Subtitle: eWaterCycle teaching platform in a box
  - Description: welcome page + jupyter + nbgrader + eWaterCycle python packages + dcache or samba
  - Logo: Organization avatar/logo on https://github.com/eWaterCycle
- Set documentation URL to `https://github.com/eWaterCycle/infra`
